...
2\) Great volumes of flows were associated with *destinations* at bus or train stations, suggesting that passengers take bus for further transit. This gives us a hint that presence of bus interchange / train stations could be an important explanotory factors for 'TRIPS' in our Spatial Interaction Model later.
...
For our curiousity of the longest bus route, we filter all trips with distances \>= 23 km irregardless of trips volume.
...
Flows from residential Woodlands/ Ponggol to Woodlands Bus interchange. Ponggol station are also badly over-predicted in our best model but predicted rather well in all the other 3 models.
...
With the models created, possible 'what-if' scenarios can be simulated; take for instance what if there are new MRT stations / development of a new residental town in the future? The models could predict new flows patterns and assist transport authority to plan ahead.

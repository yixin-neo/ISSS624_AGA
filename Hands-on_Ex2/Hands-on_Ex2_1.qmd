...
First, we will compute the distances between areas (defined using Queen contiguity method) by using [*nbdists()*](https://r-spatial.github.io/spdep/reference/nbdists.html) of **spdep**.

::: panel-tabset
### Queen's neighbours distance
...
### Fixed's neighbours distance (NYX)
